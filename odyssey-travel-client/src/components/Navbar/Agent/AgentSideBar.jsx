...
function AgentSideBar() {
    ...
    const menuItems = [
        ...
        { name: "Add/Edit Package", path: "/agent/add-package", icon: faPlusCircle },
        { name: "My Packages", path: "/agent/my-packages", icon: faBoxOpen },
                ...
                <div className="h-full px-3 py-4 ">
                    ...
                    <ul className="space-y-2 font-medium">
                      ...
                      ${active
                                                ...
                                                : "text-gray-700 dark:text-gray-300 hover:-translate-y-1 hover:scale-105 hover:bg-gray-200 dark:hover:bg-gray-800 hover:rounded-xl"}
                    `}
                                    >
                                        <FontAwesomeIcon
                                            icon={item.icon}
                    ...
                    <ul className="border-t mt-4 pt-4 border-gray-300 dark:border-gray-700">
                        <li>
                            <button
                                ...
                                className="w-full text-left flex items-center rounded-xl text-gray-700 dark:text-gray-300 hover:-translate-y-1 hover:scale-105 hover:bg-red-500 dark:hover:bg-red-900 px-5 py-3"
                            >
